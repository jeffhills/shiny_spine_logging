      ...
      box(
        ...
        jh_make_shiny_table_row_function(
          ...
          choices_vector = c("None",
                             "Prior to the exposure, Xray was used to aide in performing an erector spinae plane block, injecting a mixture containing liposomal Bupivicaine onto the lumbar spinous process.",
