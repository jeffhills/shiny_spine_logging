...
op_note_distinct_technique_statement <- function(object, level, side, interbody_statement = NULL){
  ...
  technique_statement <- case_when(
    ...
    object == 'grade_3' ~ glue("I then proceeded with the pedicle subtraction osteotomy at the level of {level}. ",
                               ...
                               "The posterior elements were resected from the {jh_get_cranial_caudal_interspace_body_list_function(level = level)$cranial_level} pedicle to {jh_get_cranial_caudal_interspace_body_list_function(level = level)$caudal_level} pedicle. ",
                               "The {jh_get_cranial_caudal_interspace_body_list_function(level = level)$cranial_level} and {level} nerve roots were identified and traced laterally. ",
                               "Once the {level} pedicle was completely skeletonized and nerve roots free, a subperiosteal plane was developed around the anterior portion of the {level} body and the retroperitoneal structures were protected. ",
                               "The {level} pedicle was resected down to the dorsal vertebral body bilaterally. ",
                               "The lateral portion of the pedicle wall was taken down, and adequate vertebral body was resected to allow for closure of the osteotomy, taking care to leave adequate anterior body and cortex. ", 
                               "Once an adequate defect had been created in the vertebral body, the dorsal wall of the vertebral body was impacted. ",
    ...
    object == 'grade_4' ~ glue("I then proceeded with an extended three column osteotomy (partial corpectomy) at the level of {level}. ", 
                               "A central laminectomy was performed and confirmed at the {jh_get_cranial_caudal_interspace_body_list_function(level = level)$cranial_level} level in order to prevent compression after osteotomy closure. ",
                               "The posterior elements were resected from the {jh_get_cranial_caudal_interspace_body_list_function(level = level)$cranial_level} pedicle to {jh_get_cranial_caudal_interspace_body_list_function(level = level)$caudal_level} pedicle. ",
                               "The {jh_get_cranial_caudal_interspace_body_list_function(level = level)$cranial_level} and {level} nerve roots were identified and traced laterally. ",
                               "Once the {level} pedicle was completely skeletonized and nerve roots free, a subperiosteal plane was developed around the anterior portion of the {level} body and the retroperitoneal structures were protected. ",
                               "Then, each pedicle was fully resected along with the dorsal and superior vertebral body. I extended the resection into the disc space, partially resecting the superior {level} endplate along with the disc. ",
                               "Once roughly 50% of the vertebral body had been resected, the nerve roots were checked again and the underside of the thecal sac was palpated to confirm no bony impingement, and the dorsal wall of the vertebral body was impacted.  ",
                               "Once I was satisfied that the thecal sac was fully decompressed circumferentially and that the {jh_get_cranial_caudal_interspace_body_list_function(level = level)$cranial_level} and {level} nerve roots were completely free, rods were connected bilaterally and the osteotomy was closed in a controlled fashion. ",
                               "Intraoperative X-ray was performed to confirm appropriate alignment and once I was satisfied with the alignment, the set screws across the osteotomy site were final tightened. "),
