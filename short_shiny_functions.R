...
################## ICD CODES FUNCTION
jh_generate_spine_diagnoses_choices_function <- function(spine_regions_input_vector = "Lumbar", diagnosis_category_input_vector = "Deformity"){
  spine_regions <- str_to_lower(paste(spine_regions_input_vector, collapse = ", "))
  ...
  if(any(diagnosis_category_input_vector == "Deformity")){
    diagnosis_categories_vector <- append(diagnosis_category_input_vector, "Pediatric Deformity")
  }else{
    diagnosis_categories_vector <- diagnosis_category_input_vector
  }
  ...
  return(spine_diagnosis_choices_list)
}
